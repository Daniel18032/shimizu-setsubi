...
$from = "danielkisawaka18032@gmail.com";
...
$require = array('お名前','telNumber','Email','備考');
...
──────────────────────
清水設備
〒400-0118 山梨県甲斐市竜王2262
TEL・FAX：055(215)0236
E-mail : danielkisawaka18032@gmail.com
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://example.com/" target="_blank">- 清水設備 -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
